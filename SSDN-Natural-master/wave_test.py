...
from ssdn.ssdn import NoiseNetwork
from utils import *
...
def main():
    noisy_file = r'D:\gitcode\BS_denoise\SSDN-Natural-master\data\denoised_images'
    out_file = r'D:\gitcode\BS_denoise\SSDN-Natural-master\data\noised_images'
    ...
    for f in files_source:
        ...
        cv2.imwrite(noisy_file + f.split("\\")[-1], I_n[0][0])
        # =========================================================
        ...
        with torch.no_grad(): # this can save much memory
            ...
            #print('2', Out.shape)#加了clamp会出现雾化
        ...
        print("Finished Generated ndeoised Files")
        # =========================================================
